;( function( elementor, $, window ) {
	...
	var ControlQuery = elementor.modules.controls.Select2.extend( {
			...
			return jQuery.extend( elementor.modules.controls.Select2.prototype.getSelect2DefaultOptions.apply( this, arguments ), {
				ajax: {
					transport: function transport( params, success, failure ) {
						...
						return elementorCommon.ajax.addRequest('classyea_query_control_filter_autocomplete', {
							data 	: data,
							success : success,
							error 	: failure,
						});
		...
		getValueTitles: function getValueTitles() {
			...
			elementorCommon.ajax.loadObjects({
				action 	: 'classyea_query_control_value_titles',
				ids 	: ids,
				data 	: {
	...
	elementor.addControlView( 'classyea-query', ControlQuery );

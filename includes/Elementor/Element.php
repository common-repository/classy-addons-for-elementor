...
class Element
{
	...
	public function classyea_widgets_registered()
	{
		...
		if(is_array($enabled_widget)) {
			foreach($enabled_widget as $enabled_widget_key) {
				...
				$widget_class 		= "ClassyEa\\Helper\\Elementor\\Widgets\\" . $enable_widget_list;
				Plugin::instance()->widgets_manager->register(new $widget_class);
			}
		}
	}
	function classyea_ele_widget_class_list(){
	...
	function classyea_ele_widget_categories( $widgets_manager )
	{

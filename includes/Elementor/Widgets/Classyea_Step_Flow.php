...
class Classyea_Step_Flow extends Widget_Base
{
	...
	protected function register_repeater_service_controls()
	{
		...
		$this->add_control(
			'bg_image',
			[
				'label'                 => esc_html__('Line Image', 'classyea'),
	...
	protected function register_style_background_controls()
	{
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .ca-number, {{WRAPPER}} .ca_stepflow4_iconbox .stepflow4_number, {{WRAPPER}} .stepflow3_number,{{WRAPPER}} .stepflow2_number',
			)
		);
		$this->add_group_control(
            Group_Control_Box_Shadow::get_type(),
		...
		$this->add_group_control(
			...
			array(
				...
				'label'    => __('Icon', 'classyea'),
				'separator' => 'after',
				'selector' => '{{WRAPPER}} .inner_iconbox4, {{WRAPPER}} .ca_stepflow3_iconbox .inner_iconbox3, {{WRAPPER}} .ca_stepflow3_inner:hover .ca_stepflow3_iconbox .stepflow3_hover_iconbox, {{WRAPPER}} .ca_stepflow_inner .ca-count-box i:before, {{WRAPPER}} .ca_stepflow2_iconbox .inner_iconbox,{{WRAPPER}} .ca_stepflow2_inner:hover .ca_stepflow2_iconbox .stepflow2_hover_iconbox',
			)
		);
				...
				<div class="ca_stepflow_one">
					<div class="ca_stepflow_inner">
						<?php if ($bg_image_hide == 'yes') { ?>
							<div class="ca-line-shape" style="background-image: url(<?php echo esc_url($bg_image); ?>);"></div>
						<?php	} ?>
						<div class="ca-count-box">
							<span class="ca-number"><?php echo $step_flow_number; ?></span>
			...
			<div class="ca_stepflow_center">
				<div class="ca_stepflow_two">
					<div class="ca_stepflow2_inner">
						<?php if ($bg_image_hide == 'yes') { ?>
							<div class="ca_line_shape2" style="background-image: url(<?php echo esc_url($bg_image); ?>);"></div>
						<?php	} ?>
						<div class="ca_stepflow2_iconbox">
							<div class="inner_iconbox">
								<?php \Elementor\Icons_Manager::render_icon(($icon_one), array('aria-hidden' => 'true')); ?>
							</div>
			...
			<div class="ca_stepflow_center">
				<div class="ca_stepflow_three">
					<div class="ca_stepflow3_inner">
						<?php if ($bg_image_hide == 'yes') { ?>
							<div class="ca_line_shape3" style="background-image: url(<?php echo esc_url($bg_image); ?>);"></div>
						<?php	} ?>
						<div class="ca_stepflow3_iconbox">
							...
							<span class="stepflow3_number"><?php echo wp_kses($step_flow_number,'classyea_kses'); ?></span>
						</div>
						<<?php echo esc_attr($title_tag); ?> class="ca_title2 ca_title_color"><?php echo $step_flow_title; ?></<?php echo esc_attr($title_tag); ?>>
						<p class="font_family_poppins"><?php echo wp_kses($step_flow_content,'classyea_kses'); ?></p>
					</div>
				</div>
			</div>
		...
		?>
			...
			<div class="ca_stepflow_four">
				<div class="ca_stepflow4_inner">
					<?php if ($bg_image_hide == 'yes') { ?>
						<div class="ca_line_shape4" style="background-image: url(<?php echo esc_url($bg_image); ?>);"></div>
					<?php	} ?>
					<div class="ca_stepflow4_iconbox">
						<div class="inner_iconbox4"><?php \Elementor\Icons_Manager::render_icon(($icon_one), array('aria-hidden' => 'true')); ?></div>

...
class Classyea_Blog_Grid extends Widget_Base
{
	...
	{
		return esc_html__('Classyea Blog Grid', 'classyea');
	}
	...
	protected function register_content_service_controls()
	{
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__('Crop title by character', 'classyea'),
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__('Crop content by character', 'classyea'),
				'type'      => Controls_Manager::NUMBER,
				'default'   => '30',
				'condition' => [
		...
		$this->add_control(
			'clad_blog_posts_num',
			[
				'label'   => esc_html__('Posts Count', 'classyea'),
				'type'    => Controls_Manager::NUMBER,
				'min'     => 1,
				'max'     => 100,
				'default' => 3,
									...
									<div class="inner-box">
										...
										<div class="lower-content">
											...
											<ul>
												<li>
													<div class="post-date">
														<span><?php echo esc_html__(get_the_date()); ?></span>
													</div>
												</li>
												<li>
													<div class="post-author">
														<span><?php echo esc_html__("by ","classyea"); ?> <span><?php echo esc_html__(get_the_author()); ?></span></span>
													</div>
												</li>
											</ul>
										</div>

...
class Classyea_Business_Hour extends Widget_Base
{
	...
	protected function register_day_style_controls()
	{
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .classyea-business-hour-time',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Wrapper Border', 'classyea' ),
				'selector' => '{{WRAPPER}} .classyea-businessHour-451 ul',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Background', 'classyea' ),
				'types' => [ 'classic', 'gradient' ],
				'selector' => '{{WRAPPER}} .classyea-business-hour-item',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .classyea-business-hour-item:not(:last-child)',
			]
		);
	...
	protected function classyea_render_business_hour_title()
	{
		...
		if ( $business_heading ) {
			...
			if ( $business_heading ) {
				$title_tag = Header::classyea_validate_html_tag( $settings['business_item_heading_tag'] );
		?>

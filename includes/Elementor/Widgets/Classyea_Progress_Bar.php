...
?>
			...
			<div data-id="progress-bar-<?php echo esc_attr($randid); ?>" class="progress-bar-<?php echo esc_attr($randid); ?> classyea-progress-bar-box wow fadeIn classyea-progress-bar-box-one" data-wow-delay="100ms" data-wow-duration="1500ms"  id="progress-bar-<?php echo esc_attr($randid); ?>">
				<<?php echo esc_attr($title_tag); ?> class="classyea-progress-bar-title"><?php echo $prograss_bar_title; ?></<?php echo esc_attr($title_tag); ?>>
				<div class="classyea-progress-bar-inner-box">
					<div class="classyea-progress-bar-outside">
						<div class="classyea-progress-bar-inner">
							<div class="classyea-progress-bar-fill" data-percent="<?php echo $ca_progress; ?>"></div>
						</div>
						<div class="classyea-progress-bar-percent"><span class="classyea-progress-bar-percent-number" data-speed="<?php echo $ca_data_speed; ?>" data-stop="<?php echo $ca_progress; ?>"></span><span class="classyea-progress-bar-percent-prefix">%</span></div>
					</div>
				</div>
			</div>
		...
		?>
			...
			<div data-id="progress-bar-<?php echo esc_attr($randid); ?>" class="progress-bar-<?php echo esc_attr($randid); ?> classyea-progress-bar-box style-two wow fadeIn" data-wow-delay="100ms" data-wow-duration="1500ms">
				...
				<<?php echo esc_attr($title_tag); ?> class="classyea-progress-bar-title style-two"><?php echo $prograss_bar_title; ?></<?php echo esc_attr($title_tag); ?>>
				<div class="classyea-progress-bar-inner-box">
					<div class="classyea-progress-bar-outside style-two">
						<div class="classyea-progress-bar-inner">
							<div class="classyea-progress-bar-fill style-two" data-percent="<?php echo $ca_progress; ?>"></div>
						</div>
						<div class="classyea-progress-bar-percent style-two"><span class="classyea-progress-bar-percent-number" data-speed="<?php echo $ca_data_speed; ?>" data-stop="<?php echo $ca_progress; ?>"></span><span class="classyea-progress-bar-percent-prefix">%</span></div>
					</div>
				</div>
			</div>
		<?php
		...
		?>
			...
			<div class="classyea-funfacts-block">
				...
				<div class="classyea-funfacts-number">
					<span class="classyea-funfacts-count-text" data-speed="<?php echo $ca_data_speed; ?>" data-stop="<?php echo $ca_progress; ?>"></span><span class="classyea-funfacts-count-prefix">%</span>
				</div>
				<<?php echo esc_attr($title_tag); ?> class="classyea-funfacts-title"><?php echo $prograss_bar_title; ?></<?php echo esc_attr($title_tag); ?>>
			</div>
		...
		?>
			...
			<div data-id="progress-bar-<?php echo esc_attr($randid); ?>" class="progress-bar-<?php echo esc_attr($randid); ?> classyea-progress-bar-box style-three wow fadeIn" data-wow-delay="100ms" data-wow-duration="1500ms">
				...
				<<?php echo esc_attr($title_tag); ?> class="classyea-progress-bar-title style-three"><?php echo $prograss_bar_title; ?></<?php echo esc_attr($title_tag); ?>>
				<div class="classyea-progress-bar-inner-box">
					<div class="classyea-progress-bar-outside style-three">
						<div class="classyea-progress-bar-inner style-three">
							<div class="classyea-progress-bar-fill style-three" data-percent="<?php echo $ca_progress; ?>"></div>
						</div>
						<div class="classyea-progress-bar-percent style-three"><span class="classyea-progress-bar-percent-number" data-speed="<?php echo $ca_data_speed; ?>" data-stop="<?php echo $ca_progress; ?>"></span><span class="classyea-progress-bar-percent-prefix">%</span></div>
					</div>
				</div>
			</div>
		...
		?>
			...
			<div data-id="progress-bar-<?php echo esc_attr($randid); ?>" class="progress-bar-<?php echo esc_attr($randid); ?> classyea-progress-bar-box style-four wow fadeIn" data-wow-delay="100ms" data-wow-duration="1500ms">
				<<?php echo esc_attr($title_tag); ?> class="classyea-progress-bar-title style-four"><?php echo $prograss_bar_title; ?></<?php echo esc_attr($title_tag); ?>>
				<div class="classyea-progress-bar-inner-box">
					<div class="classyea-progress-bar-outside style-four">
						<div class="classyea-progress-bar-inner style-four">
							<div class="classyea-progress-bar-fill style-four" data-percent="<?php echo $ca_progress; ?>">
								<div class="classyea-progress-bar-percent style-four"><span class="ca-icon"><?php \Elementor\Icons_Manager::render_icon(($icon), array('aria-hidden' => 'true')); ?></span><span class="classyea-progress-bar-percent-number" data-speed="<?php echo $ca_data_speed; ?>" data-stop="<?php echo $ca_progress; ?>"></span><span class="classyea-progress-bar-percent-prefix">%</span></div>
							</div>
						</div>
					</div>
				</div>
			...
			<div data-id="progress-bar-<?php echo esc_attr($randid); ?>" class="progress-bar-<?php echo esc_attr($randid); ?> classyea-progress-bar-box style-five wow fadeIn" data-wow-delay="100ms" data-wow-duration="1500ms">
				<div class="classyea-progress-bar-inner-box">
					<div class="classyea-progress-bar-percent-shape">
						<div class="classyea-progress-bar-percent style-five"><span class="classyea-progress-bar-percent-number" data-speed="<?php echo $ca_data_speed; ?>" data-stop="<?php echo $ca_progress; ?>"></span><span class="classyea-progress-bar-percent-prefix">%</span></div>
					</div>
					<div class="classyea-progress-bar-outside style-five">
						<div class="classyea-progress-bar-inner style-five">
							<div class="classyea-progress-bar-fill style-five" data-percent="<?php echo $ca_progress; ?>"></div>
						</div>
					</div>
				</div>
				<<?php echo esc_attr($title_tag); ?> class="classyea-progress-bar-title style-five"><?php echo $prograss_bar_title; ?></<?php echo esc_attr($title_tag); ?>>
			</div>
		<?php
		...
		?>
			...
			<div data-id="progress-bar-<?php echo esc_attr($randid); ?>" class="progress-bar-<?php echo esc_attr($randid); ?> classyea-progress-bar-box style-six wow fadeIn" data-wow-delay="100ms" data-wow-duration="1500ms">
				<<?php echo esc_attr($title_tag); ?> class="classyea-progress-bar-title style-six"><?php echo $prograss_bar_title; ?></<?php echo esc_attr($title_tag); ?>>
				<div class="classyea-progress-bar-inner-box p-relative">
					<div class="classyea-progress-bar-percent style-six"><span class="classyea-progress-bar-percent-number" data-speed="<?php echo $ca_data_speed; ?>" data-stop="<?php echo $ca_progress; ?>"></span><span class="classyea-progress-bar-percent-prefix">%</span></div>
					...
					<div class="classyea-progress-bar-outside style-six">
						<div class="classyea-progress-bar-inner style-six">
							<div class="classyea-progress-bar-fill style-six" data-percent="<?php echo $ca_progress; ?>"></div>
						</div>
					</div>
				</div>
			</div>
		...
		?>
			...
			<div data-id="progress-bar-<?php echo esc_attr($randid); ?>" class="progress-bar-<?php echo esc_attr($randid); ?> classyea-progress-bar-box style-seven wow fadeIn" data-wow-delay="100ms" data-wow-duration="1500ms">
				<div class="classyea-progress-bar-inner-box p-relative">
					<div class="classyea-progress-bar-percent style-seven"><span class="classyea-progress-bar-percent-number" data-speed="<?php echo $ca_data_speed; ?>" data-stop="<?php echo $ca_progress; ?>"></span><span class="classyea-progress-bar-percent-prefix">%</span></div>
					<div class="classyea-progress-bar-outside style-seven">
						<div class="classyea-progress-bar-inner style-seven">
							<div class="classyea-progress-bar-fill-two" data-percent="<?php echo $ca_progress; ?>"></div>
						</div>
					</div>
				</div>
				<<?php echo esc_attr($title_tag); ?> class="classyea-progress-bar-title style-seven"><?php echo $prograss_bar_title; ?></<?php echo esc_attr($title_tag); ?>>
				<div class="classyea-progress-bar-description"><?php echo $prograss_content; ?></div>
			</div>
		<?php
		...
		?>
			...
			<div data-id="progress-bar-<?php echo esc_attr($randid); ?>" class="progress-bar-<?php echo esc_attr($randid); ?> classyea-progress-bar-two-box wow fadeIn" data-wow-delay="100ms" data-wow-duration="1500ms">
				...
				<span class="data-parcent d-none"><?php echo $ca_progress; ?></span>
				<div class="text-center">
					<div class="classyea-progress-bar-icon-two"><?php \Elementor\Icons_Manager::render_icon(($icon), array('aria-hidden' => 'true')); ?></div>
					<<?php echo esc_attr($title_tag); ?> class="classyea-progress-bar-title-three style-two">
						<div class="classyea-progress-bar-percent style-eight"><span class="classyea-progress-bar-percent-number" data-speed="<?php echo $ca_data_speed; ?>" data-stop="<?php echo $ca_progress; ?>"></span><span class="classyea-progress-bar-percent-prefix">%</span></div>
						<?php echo $prograss_bar_title; ?>
					</<?php echo esc_attr($title_tag); ?>>
					<div class="classyea-progress-bar-description-two"><?php echo $prograss_content; ?></div>
				</div>
			</div>
			...
			<div data-id="progress-bar-<?php echo esc_attr($randid); ?>" class="progress-bar-<?php echo esc_attr($randid); ?> classyea-progress-bar-two-box style-two wow fadeIn" data-wow-delay="100ms" data-wow-duration="1500ms">
				<div class="classyea-progress-bar-outside style-eight">
					<div class="classyea-progress-bar-inner style-eight">
						<div class="classyea-progress-bar-fill-two style-two" data-percent="<?php echo $ca_progress; ?>"></div>
					</div>
				</div>
				<div class="text-left">
					<div class="classyea-progress-bar-icon-two"><?php \Elementor\Icons_Manager::render_icon(($icon), array('aria-hidden' => 'true')); ?></div>
					<<?php echo esc_attr($title_tag); ?> class="classyea-progress-bar-title-three style-two">
						<div class="classyea-progress-bar-percent style-eight"><span class="classyea-progress-bar-percent-number" data-speed="<?php echo $ca_data_speed; ?>" data-stop="<?php echo $ca_progress; ?>"></span><span class="classyea-progress-bar-percent-prefix">%</span></div> <?php echo $prograss_bar_title; ?>
					</<?php echo esc_attr($title_tag); ?>>
					<div class="classyea-progress-bar-description-two"><?php echo $prograss_content; ?></div>
				</div>
			</div>

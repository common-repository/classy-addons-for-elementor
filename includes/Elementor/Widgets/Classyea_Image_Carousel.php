...
class Classyea_Image_Carousel extends Widget_Base
{
	...
	protected function render()
	{
		...
		if ($carousel_layout == 'layout-1') { ?>
			<div class="classyea-carousel-wrapper-801" id="slider-one" data-slider='<?php echo wp_json_encode($changed_atts);?>'>
			...
			<div class="classyea-addons-container-right">
				<div class="classyea-carousel-wrapper-802">
					<div class="sliders-carousel sliderstype2" id="sliders"  style="width: 100%; height: 365px;"  data-nav='<?php echo wp_json_encode($changed_atts_two);?>'>
						<?php $this->classyea_carousel_repeater_control(); ?>
					</div>
				</div>
			</div>
			...
			<div class="classyea-imageCarousel-wrapper-803" id="slider-three" data-sliderthree='<?php echo wp_json_encode($changed_atts);?>'>
			...
			<div class="classyea-imageCarousel-bottom-804" id="slider-four" data-sliderfour='<?php echo wp_json_encode($changed_atts);?>'>
				<ul class="owl-carousel owl-theme">
					<?php $this->classyea_carousel_repeater_control(); ?>
				</ul>
			...
			<div class="classyea-imageCarousel-wrapper-807" id="slider-five" data-sliderfive='<?php echo wp_json_encode($changed_atts);?>'>
			...
			<div class="classyea-imageCarousel-805" id="slider-six" data-slidersix='<?php echo wp_json_encode($changed_atts);?>'>
				<ul class="owl-carousel owl-theme">
					<?php $this->classyea_carousel_repeater_control(); ?>
	...
	protected function classyea_render_title_heading($item, $key)
	{
		...
		if ($title_subtitle_on_off == 'yes') {
			if ($item['slider_title']) {
				...
				if ($item['slider_title']) {
					$title_tag = Header::classyea_validate_html_tag($item['title_tag']);
			?>

...
class Classyea_Image_Comparison extends Widget_Base
{
	...
	protected function render()
	{
		...
		if ($orientation == 'vertical') {
			$vertical = 'classyea-image-comparison-vertical';
		}
		...
		<div class="classyea-before-after-work-area" data-uniqueid="<?php echo esc_attr($unique_id); ?>">
			<div class="classyea-before-after-content">
				<div class="before-after">
					<div data-id="classyea-wrinkle-before-after-<?php echo esc_attr($unique_id); ?>" class="classyea-before-after-twentytwenty" id="classyea-wrinkle-before-after<?php echo esc_attr($unique_id); ?>" data-verticalhorizontal='<?php echo wp_json_encode($changed_atts); ?>'>

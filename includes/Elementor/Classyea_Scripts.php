<?php
namespace ClassyEa\Helper\Elementor;
...
class Classyea_Scripts {
    ...
    public function classyea_css_list( $classyea_css_path ) {
        ...
        $classyea_css_path = [
            ...
            CLASSYEA_PLUGIN_PATH . "assets/elementor/front/css/bootstrap/",
            CLASSYEA_PLUGIN_PATH . "assets/elementor/front/css/heading/",
            CLASSYEA_PLUGIN_PATH . "assets/elementor/front/css/newsticker/",
            CLASSYEA_PLUGIN_PATH . "assets/elementor/front/css/header-info/",
        ];
    ...
    public function classyea_css_list_url() {
        ...
        $css_path_url = [
            ...
            CLASSYEA_PLUGIN_URL . "assets/elementor/front/css/bootstrap/",
            CLASSYEA_PLUGIN_URL . "assets/elementor/front/css/heading/",
            CLASSYEA_PLUGIN_URL . "assets/elementor/front/css/newsticker/",
            CLASSYEA_PLUGIN_URL . "assets/elementor/front/css/header-info/",
        ];
    ...
    public function classyea_array_list( $classyea_css_array ) {
        ...
        $classyea_css_array = array(
            ...
            'classyea-widget-progress-bar'     => array(
                'css'      => array( 'progress-bar','progressbar','bootstrap' ),
                'js'       => array(),
                'external' => array(
                    'css' => array(),
                    'js'  => array(),
            ...
            'classyea-news-ticker'       => array(
                'css'      => array( 'newsticker','bootstrap'),
                'js'       => array(),
                'external' => array(
                    'css' => array(),
                    'js'  => array(),
            ...
            'classyea-header-info'       => array(
                'css'      => array( 'headerinfo'),
                'js'       => array(),
                'external' => array(
                    'css' => array(),
                    'js'  => array(),

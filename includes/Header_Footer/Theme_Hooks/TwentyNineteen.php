...
class TwentyNineteen {
	...
	public function get_header( $name ) {
		add_action(
			'classyea/template/after_header',
			function() {
				echo '<div id="page" class="site">';
				echo '<div id="content" class="site-content">';
			}
		);
		require __DIR__ . '/../Views/Theme_Support_Header.php';
	...
	public function get_footer( $name ) {
		add_action(
			'classyea/template/after_footer',
			function() {
				echo '</div></div>';
			}
		);

		require __DIR__ . '/../Views/Theme_Support_Footer.php';

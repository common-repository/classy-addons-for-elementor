...
class Classyea_Testimonial extends Widget_Base
{
	...
	protected function register_content_style_controls()
	{
		...
		$this->add_responsive_control(
			'classyea_testimonial_margin_desc',
			[
				'label'      => esc_html__('Margin', 'classyea'),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => ['px', '%', 'em'],
	...
	protected function render()
	{
		...
		$this->add_render_attribute( 'testimonial_settings', 'data-testimonial' , wp_json_encode( $changed_atts ) );



		if ($testimonial_layout == 'layout-1') { ?>
			<!-- Client Testimonials -->
			<section class="classyea-client-testimonials" id="testimonial_client" <?php $this->print_render_attribute_string( 'testimonial_settings' ); ?>>
			...
			<?php } elseif ($testimonial_layout == 'layout-2') { ?>
				<!-- Right Column -->
				<div class="classyea-testimonial-two" id="testimonial_two" <?php $this->print_render_attribute_string( 'testimonial_settings' ); ?>>
			...
			<?php } elseif ($testimonial_layout == 'layout-5') { ?>
				<div class="classyea-design-five owl-carousel owl-theme" id="testimonial_five" <?php $this->print_render_attribute_string( 'testimonial_settings' ); ?>>
					<?php  $this->classyea_render_testimonial_repeater_control(); ?>
				</div>
			<?php } else { ?>
				<div id="<?php echo esc_attr($section_id); ?>" class="<?php echo esc_attr($section_class); ?>" <?php $this->print_render_attribute_string( 'testimonial_settings' ); ?>>
					<?php $this->classyea_render_testimonial_repeater_control(); ?>
		...
		private function classyea_render_testimonial_name($testimonial_item, $index)
		{
			if ($testimonial_item['client_name']) {
				...
				if ($testimonial_item['client_name']) {
					$name_tag = Classyea_Helper::classyea_validate_html_tag($testimonial_item['testimonial_name_tag']);
				?>
		...
		protected function classyea_render_testimonial_designation($testimonial_item, $index)
		{
			if ($testimonial_item['designation']) {
				...
				if ($testimonial_item['designation']) {
					$testimonial_designation_tag = Classyea_Helper::classyea_validate_html_tag($testimonial_item['testimonial_designation_tag']);
				?>

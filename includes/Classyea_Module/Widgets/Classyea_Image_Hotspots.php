...
class Classyea_Image_Hotspots extends Widget_Base
{
	...
	/**
	 * Retrieve Image Hotspots widget category.
	 * @access public
	 * @return string Widget icon.
	 */
	...
	protected function classyea_rer_hotspots_image_control()
	{
		...
		/**
		 * Content Repeater: Image Hotspots
		 */
		$this->start_controls_section(
...
?>
	...
	private function classyea_hotspots_repeater_control()
	{
		...
		foreach ($settings['hotspot_item'] as $index => $item) :
			...
			$this->add_render_attribute( 'hotspots_settings', 'data-icon' , wp_json_encode( $changed_atts ) );

			if ($hotspot_layout == 'layout-1') {
			?>
				<!-- Hotspot -->
				<div class="classyea-hotSpot elementor-repeater-item-<?php echo esc_attr($item['_id']); ?>" data-tooltipText='<?php echo wp_kses($tooltip_content, 'classyea_kses'); ?>' data-tooltipBg='<?php echo esc_attr($tooltip_bg); ?>' data-toolTipColor="<?php echo esc_attr($tooltip_color_single); ?>"  data-radius="<?php echo esc_attr($border_radius); ?>" <?php $this->print_render_attribute_string( 'hotspots_settings' ); ?>></div>
			<?php
			} elseif ($hotspot_layout == 'layout-2') { 
				$this->add_render_attribute( 'hotspots_settings_two', 'data-icontwo' , wp_json_encode( $changed_atts ) );
				?>
				<div id="classyea-hotSpot" class="classyea-hotSpot elementor-repeater-item-<?php echo esc_attr($item['_id']); ?>" <?php $this->print_render_attribute_string( 'hotspots_settings' ); ?> <?php $this->print_render_attribute_string( 'hotspots_settings_two' ); ?> data-tooltipText='<?php echo wp_kses($tooltip_content, 'classyea_kses'); ?>' data-tooltipBg='<?php echo esc_attr($tooltip_bg); ?>' data-toolTipColor="<?php echo esc_attr($tooltip_color_single); ?>"  data-radius="<?php echo esc_attr($border_radius); ?>" data-hotspot_text="<?php echo wp_kses($classyea_hotspot_text, 'classyea_kses'); ?>"></div>

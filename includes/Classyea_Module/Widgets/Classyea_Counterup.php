...
class Classyea_Counterup extends Widget_Base
{
	...
	protected function register_repeater_counter_controls()
	{
		...
		$this->add_control(
			'counter_surfix',
			[
				'label'                 => __('Number Surfix', 'classyea'),
				'type'                  => Controls_Manager::TEXT,
				'dynamic'               => [
					'active'   => true,
				],
	...
	protected function classyea_register_style_counter_number_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default'               => '',
				'selectors'             => [
					'{{WRAPPER}} .classyea-counterUp__box-item-101 .counter-number' => 'color: {{VALUE}};',
					'{{WRAPPER}} .number' => 'color: {{VALUE}};',
					'{{WRAPPER}} .number102' => 'color: {{VALUE}};',
					'{{WRAPPER}} .number103' => 'color: {{VALUE}}!important;',
					'{{WRAPPER}} .counter-six' => 'color: {{VALUE}};',
					'{{WRAPPER}} .numberplus' => 'color: {{VALUE}};',
					'{{WRAPPER}} #classyea-counterUp-box-102 .classyea-counterUp-item-102 h2' => 'color: {{VALUE}};',
				]
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'              => '{{WRAPPER}} .classyea-counterUp__box-item-101 .counter-number,{{WRAPPER}} .number,{{WRAPPER}} .number102 span,{{WRAPPER}} .number103 span,{{WRAPPER}} .numberplus',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'             => [
					'{{WRAPPER}} .classyea-counterUp__box-item-101 .counter-number' => 'margin-top: {{TOP}}{{UNIT}}; margin-left: {{LEFT}}{{UNIT}}; margin-right: {{RIGHT}}{{UNIT}}; margin-bottom: {{BOTTOM}}{{UNIT}};',
					...
					'{{WRAPPER}} .counter-six' => 'margin-top: {{TOP}}{{UNIT}}; margin-left: {{LEFT}}{{UNIT}}; margin-right: {{RIGHT}}{{UNIT}}; margin-bottom: {{BOTTOM}}{{UNIT}};',
				]
			]
		);
	...
	protected function render()
	{
		...
		protected function classyea_counter_box_control()
		{
			...
			$counter_surfix = $settings['counter_surfix'];
		?>
		<div class="<?php echo esc_attr($item_class); ?>">
			...
			if ('layout-3' == $counter_layout || 'layout-1' == $counter_layout) { 
				?>
				<h3 class="counter-number"><span class="number" data-start="<?php echo esc_attr($starting_number);?>" data-target="<?php echo esc_attr($ending_number); ?>" data-speed="<?php echo esc_attr($counter_speed['size']); ?>"><?php echo wp_kses($ending_number,'classyea_kses'); ?></span><span class="numberplus"><?php echo wp_kses($counter_surfix,'classyea_kses');?></span></h3>
				<?php $this->classyea_title_tag();
			} elseif ('layout-5' === $counter_layout) { ?>
				<div class="classyea-counterUp-text">
					<h3 class="number103"><span id="number103" data-speed="<?php echo esc_attr($counter_speed['size']); ?>" data-start="<?php echo esc_attr($starting_number);?>" data-target="<?php echo esc_attr($ending_number); ?>"></span><span class="numberplus"><?php echo wp_kses($counter_surfix,'classyea_kses');?></span></h3>
					<?php $this->classyea_title_tag();?>
				</div>
			<?php } elseif ('layout-4' === $counter_layout) { ?>
				<h2 class="number102"><span id="number102" data-speed="<?php echo esc_attr($counter_speed['size']); ?>" data-start="<?php echo esc_attr($starting_number);?>" data-target="<?php echo esc_attr($ending_number); ?>"><?php echo wp_kses($ending_number,'classyea_kses'); ?></span><span class="numberplus"><?php echo wp_kses($counter_surfix,'classyea_kses');?></span></h2>
				<?php $this->classyea_title_tag();
			} elseif ('layout-6' === $counter_layout) { ?>
				<h3 class="counter-six"><span class="counter number" data-start="<?php echo esc_attr($starting_number); ?>" data-target="<?php echo esc_attr($ending_number); ?>" data-speed="<?php echo esc_attr($counter_speed['size']); ?>"><?php echo wp_kses($ending_number,'classyea_kses'); ?></span><span class="numberplus"><?php echo wp_kses($counter_surfix,'classyea_kses');?></span></h3>
				<?php $this->classyea_title_tag();
			} ?>
		</div>
	<?php
		...
		<div class="classyea-counterUp__box-item-106 count-box">
			...
			?>
			<h3><span class="number" data-start="<?php echo esc_attr($starting_number);?>" data-target="<?php echo esc_attr($ending_number); ?>" data-speed="<?php echo esc_attr($counter_speed['size']); ?>"><?php echo wp_kses($ending_number,'classyea_kses'); ?></span><span class="numberplus"><?php echo wp_kses($counter_surfix,'classyea_kses');?></span></h3>
			<?php $this->classyea_title_tag();?>
		</div>
	<?php
	}
	...
	protected function classyea_title_tag(){
		...
		if ($item_counter_title_two) {
			...
			$counter_title_tag = Classyea_Helper::classyea_validate_html_tag($counter_title_tag);
		?>

...
class Classyea_Team_Member extends Widget_Base
{
	...
	**/
	...
	protected function register_team_style_controls(){
		...
		$this->add_responsive_control(
			'team_social_alignment',
			[
				'label'                 => __( 'Social Alignment', 'classyea' ),
				'type'                  => Controls_Manager::CHOOSE,
				'options'               => [
					'flex-start'      => [
						'title' => __( 'Left', 'classyea' ),
				...
				'default'               => 'center',
				'selectors'             => [
					'{{WRAPPER}} .classyea-team-item-253 .classyea-team-social li ' => 'justify-content: {{VALUE}};',
					
				],
				'condition'             => [
					'team_member_layout'    => 'layout-3',
				]
			]
		);
		$this->add_responsive_control(
		...
		$this->add_group_control(
			...
			[
				...
				'selector'              => '{{WRAPPER}} .classyea-team-name,{{WRAPPER}} .classyea-team-item-254 .classyea-team-name,{{WRAPPER}} .classyea-team-255 .classyea-team-name',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors'             => [
					...
					'{{WRAPPER}} .classyea-team-255 .classyea-team-name' => 'color: {{VALUE}}',
				]
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'             => [
					...
					'{{WRAPPER}} .classyea-team-255 .classyea-team-name' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				]
			]
		);
	...
	protected function register_classyea_style_description_controls() {
		...
		$this->add_group_control(
			...
			[
				...
				'label'                 => __( 'Typography', 'classyea' ),
				'selector'              => '{{WRAPPER}} .classyea-text,{{WRAPPER}} .classyea-team-item-254 .classyea-team-bio',
			] 
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'             => [
					'{{WRAPPER}} .classyea-text' => 'margin-top: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .classyea-team-item-254 .classyea-team-bio' => 'margin-top: {{SIZE}}{{UNIT}};',
				]
			]
		);
		$this->end_controls_section();
	...
	protected function register_classyea_style_social_links_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors'             => [
					...
					'{{WRAPPER}} .classyea-team-box-252 .classyea-team-social .classyea-team-social-links a' => 'color: {{VALUE}};',
					'{{WRAPPER}} .classyea-team-item-253 .classyea-team-social li a' => 'color: {{VALUE}};',
					'{{WRAPPER}} .classyea-team-item-254 .classyea-team-social .classyea-team-social-links a' => 'color: {{VALUE}};',
					...
					'{{WRAPPER}} .classyea-team-box-251 .classyea-team-overly-inner .classyea-team-social-links a i' => 'color: {{VALUE}}!important;',
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors'             => [
					...
					'{{WRAPPER}} .classyea-team-item-254 .classyea-team-social .classyea-team-social-links  a' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .classyea-team-255 .classyea-team .classyea-team-content .classyea-team-icon i' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .classyea-team-box-251 .classyea-team-overly-inner .classyea-team-social-links a' => 'background-color: {{VALUE}};',
				]
			]
		);
		$this->add_group_control(
		...
		$this->add_control(
			...
			[
				...
				'default'               => '',
				'selectors'             => [
					'{{WRAPPER}} .classyea-team-box-252 .classyea-team-social .classyea-team-social-links a:hover' => 'color: {{VALUE}};',
					'{{WRAPPER}} .classyea-team-item-253 .classyea-team-social li a:hover' => 'color: {{VALUE}};',
					'{{WRAPPER}} .classyea-team-item-254:hover .classyea-team-social .classyea-team-social-links a' => 'color: {{VALUE}};',
					'{{WRAPPER}} .classyea-team-255 .classyea-team .classyea-team-content .classyea-team-icon i:hover' => 'color: {{VALUE}};',
					'{{WRAPPER}} .classyea-team-box-251 .classyea-team-overly-inner:hover .classyea-team-social-links a i' => 'color: {{VALUE}}!important;',
		...
		$this->add_control(
			...
			[
				...
				'selectors'             => [
					...
					'{{WRAPPER}} .classyea-team-item-254:hover .classyea-team-social .classyea-team-social-links a' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .classyea-team-255 .classyea-team .classyea-team-content .classyea-team-icon i:hover' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .classyea-team-box-251 .classyea-team-overly-inner .classyea-team-social-links a:hover' => 'background-color: {{VALUE}};',
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors'             => [
					...
					'{{WRAPPER}} .classyea-team-box-252 .classyea-team-social .classyea-team-social-links a:hover' => 'border-color: {{VALUE}};',
					'{{WRAPPER}} .classyea-team-item-253 .classyea-team-social li a:hover' => 'border-color: {{VALUE}};',
					'{{WRAPPER}} .classyea-team-item-254:hover .classyea-team-social .classyea-team-social-links a' => 'border-color: {{VALUE}};',
					'{{WRAPPER}} .classyea-team-255 .classyea-team .classyea-team-content .classyea-team-icon i:hover' => 'border-color: {{VALUE}};',
					'{{WRAPPER}} .classyea-team-box-251:hover .classyea-team-social .classyea-team-social-links a' => 'border-color: {{VALUE}};',
				]
			]
		);
		$this->end_controls_tab();
		...
		$this->add_group_control(
			...
			[
				...
				'label'                 => __( 'Typography', 'classyea' ),
				'selector'              => '{{WRAPPER}} .classyea-team-box-251 .classyea-team-image .classyea-team-social .classyea-team-social-links a,{{WRAPPER}} .classyea-team-box-252 .classyea-team-social .classyea-team-social-links a,{{WRAPPER}} .classyea-team-item-253 .classyea-team-social li a,{{WRAPPER}} .classyea-team-item-254 .classyea-team-social .classyea-team-social-links a,{{WRAPPER}} .classyea-team-255 .classyea-team .classyea-team-content .classyea-team-icon .classyea-team-social-links i,{{WRAPPER}} .classyea-team-box-251 .classyea-team-overly-inner .classyea-team-social-links a i',
			] 
		);
		$this->add_control(
			...
			[
				...
				'selectors'             => [
					...
					'{{WRAPPER}} .classyea-team-box-252 .classyea-team-social .classyea-team-social-links a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .classyea-team-item-253 .classyea-team-social li a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .classyea-team-item-254 .classyea-team-social .classyea-team-social-links a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'             => [
					...
					'{{WRAPPER}} .classyea-team-box-252 .classyea-team-social .classyea-team-social-links a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .classyea-team-item-253 .classyea-team-social li a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .classyea-team-item-254 .classyea-team-social .classyea-team-social-links a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		...
		$this->add_responsive_control(
			...
			[
				...
				'separator'             => 'before',
				'selectors'             => [
					'{{WRAPPER}} .classyea-team-box-251 .classyea-team-image .classyea-team-social .classyea-team-social-links' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .classyea-team-box-252 .classyea-team-social .classyea-team-social-links' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .classyea-team-item-253 .classyea-team-social li' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .classyea-team-item-254 .classyea-team-social .classyea-team-social-links' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .classyea-team-255 .classyea-team-icon .classyea-team-social-links' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				]
			]
		);
		$this->end_controls_section();
		...
		$this->start_controls_section(
			'section_member_contact_info_style',
			[
		...
		$this->start_controls_tabs( 'tabs_contact_info_style' );

		$this->start_controls_tab(
			'tab_contact_info_normal',
			[
				'label'                 => __( 'Normal', 'classyea' ),
			]
		);
		$this->add_control(
			'contact_info_phone_email_color',
			[
				'label'                 => __( 'Phone/E-mail Color', 'classyea' ),
				'type'                  => Controls_Manager::COLOR,
				'default'               => '',
				'selectors'             => [
					'{{WRAPPER}} .classyea-team-box-252 .classyea-team-email a' => 'color: {{VALUE}};',
					'{{WRAPPER}} .classyea-team-box-251 .classyea-team-email a' => 'color: {{VALUE}};',
					'{{WRAPPER}} .classyea-team-item-254 .classyea-team-email a' => 'color: {{VALUE}};',
					'{{WRAPPER}} .classyea-team-box-252 .classyea-team-phone a' => 'color: {{VALUE}};',
					'{{WRAPPER}} .classyea-team-item-254 .classyea-team-phone a' => 'color: {{VALUE}};',
					'{{WRAPPER}} .classyea-team-box-251 .classyea-team-phone a' => 'color: {{VALUE}};',
				]
			]
		);

		$this->add_control(
			'contact_info_normal_color',
			[
				...
				'selectors'             => [
					...
					'{{WRAPPER}} .classyea-team-box-251 .classyea-team-email a i' => 'color: {{VALUE}};',
					'{{WRAPPER}} .classyea-team-item-254 .classyea-team-email a i' => 'color: {{VALUE}};',
					'{{WRAPPER}} .classyea-team-box-252 .classyea-team-phone a i' => 'color: {{VALUE}};',
					'{{WRAPPER}} .classyea-team-item-254 .classyea-team-phone a i' => 'color: {{VALUE}};',
					'{{WRAPPER}} .classyea-team-box-251 .classyea-team-phone a i' => 'color: {{VALUE}};',
				]
			]
		);
		...
		$this->start_controls_tab(
			'tab_contactinfo_hover',
			[
				'label'                 => __( 'Hover', 'classyea' ),
			]
		);
		$this->add_control(
			'contact_info_phone_email_color_hover',
			[
				'label'                 => __( 'Phone/E-mail Color', 'classyea' ),
				'type'                  => Controls_Manager::COLOR,
				'default'               => '',
				'selectors'             => [
					'{{WRAPPER}} .classyea-team-item-254 .classyea-team-email a:hover' => 'color: {{VALUE}};',
					'{{WRAPPER}} .classyea-team-box-252 .classyea-team-email a:hover' => 'color: {{VALUE}};',
					'{{WRAPPER}} .classyea-team-box-251 .classyea-team-email a:hover' => 'color: {{VALUE}};',
					'{{WRAPPER}} .classyea-team-box-252 .classyea-team-phone a:hover' => 'color: {{VALUE}};',
					'{{WRAPPER}} .classyea-team-box-251 .classyea-team-phone a:hover' => 'color: {{VALUE}};',
					'{{WRAPPER}} .classyea-team-item-254 .classyea-team-phone a:hover' => 'color: {{VALUE}};',
				]
			]
		);
		$this->add_control(
			...
			[
				...
				'default'               => '',
				'selectors'             => [
					'{{WRAPPER}} .classyea-team-item-254 .classyea-team-email a:hover i' => 'color: {{VALUE}};',
					'{{WRAPPER}} .classyea-team-box-252 .classyea-team-email a:hover i' => 'color: {{VALUE}};',
					'{{WRAPPER}} .classyea-team-box-251 .classyea-team-email a:hover i' => 'color: {{VALUE}};',
					'{{WRAPPER}} .classyea-team-box-252 .classyea-team-phone a:hover i' => 'color: {{VALUE}};',
					'{{WRAPPER}} .classyea-team-box-251 .classyea-team-phone a:hover i' => 'color: {{VALUE}};',
					'{{WRAPPER}} .classyea-team-item-254 .classyea-team-phone a:hover i' => 'color: {{VALUE}};',
				]
			]
		);
		$this->end_controls_tab();
	...
	protected function register_style_team_overlay_controls() {
		...
		$this->add_control(
			...
			[
				'label'     => __('Overlay Background', 'classyea'),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
				'condition'             => [
					'team_member_layout'    => 'layout-6',
				]
			]
		);
		$this->add_group_control(
			Group_Control_Background::get_type(),
			[
				'name'                  => 'fdfdcontentarea_backgroundsss',
				'label'                 => __( 'Background', 'classyea' ),
				'types'                 => [ 'classic', 'gradient' ],
				'separator'             => 'before',
...
?>
	...
	private function classyea_render_team_member_repeater_control()
	{
		$settings 				= $this->get_settings_for_display();
		$team_member_layout 	= $settings['team_member_layout'];
		$image_class = "classyea-team-image";

		switch ($team_member_layout) {
			case 'layout-1':
				$settings_id = "classyea-team-box-251";
				break;
			case 'layout-2':
				$settings_id = "classyea-team-box-252";
				break;
			case 'layout-3':
				$settings_id = "classyea-team-item-253";
				$image_class = "classyea-team-img";
				break;
			case 'layout-4':
				$settings_id = "classyea-team-item-254";
				$image_class = "classyea-team-img";
				break;
			case 'layout-5':
				$settings_id = "classyea-team";
				$image_class = "classyea-team-img";
				break;
			case 'layout-6':
				$settings_id = "classyea-team";
		...
		<?php else : ?>
			<div class="<?php echo esc_attr($social_div_class); ?>">
				...
				<div class="classyea-team-overly-inner">
					...
					<div class="classyea-team-phone"><a href="tel:<?php echo esc_attr($team_phone_no_tel); ?>">
					<?php Icons_Manager::render_icon( $settings['team_phone_icon'], array( 'aria-hidden' => 'true' ) ); ?><?php echo wp_kses($team_phone_no,'classyea_kses'); ?></a></div>
					<?php } ?>
					<?php if(!empty($settings['team_email'])){ ?>
					<div class="classyea-team-email"><a href="mailto:<?php echo esc_attr($settings['team_email']); ?>"><?php Icons_Manager::render_icon( $settings['team_email_icon'], array( 'aria-hidden' => 'true' ) ); ?><?php echo wp_kses($settings['team_email'],'classyea_kses'); ?></a></div>
					<?php } ?>
				<?php endif; ?>
		...
		if ('title' === $settings['link_type'] && $settings['link']['url']) {
			...
			<div class="classyea-team-text">
				<a <?php echo wp_kses_post($this->get_render_attribute_string($link_key)); ?>>
					<?php
					if ($team_member_name) {
						$team_name_title_tag = Classyea_Helper::classyea_validate_html_tag($team_member_name_tag);
					?>
				...
				if ($team_member_position) {
					$team_position_tag = Classyea_Helper::classyea_validate_html_tag($team_member_position_tag);
				?>

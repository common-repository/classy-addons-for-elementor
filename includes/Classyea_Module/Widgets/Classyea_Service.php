	...
	**/
	protected function register_repeater_service_controls()
	{
		...
		$this->add_control(
			'subheading_enable',
			[
				'label' => esc_html__( 'Sub Heading Enable?', 'classyea' ),
				'type' => Controls_Manager::SWITCHER,
		...
		$this->add_control(
			'service_sub_heading',
			[
				'label'       => esc_html__('Service Sub Heading', 'classyea'),
				'type'        => Controls_Manager::TEXT,
				'dynamic'     => [
					'active' => true,
				],
				'label_block' => true,
				'default'     => esc_html__('Explore', 'classyea'),
				'condition'             => [
					'service_layout'    => 'layout-3',
					'subheading_enable'    => 'yes',
				]
			]
		);
		$this->add_control(
	...
	protected function register_style_background_controls()
	{
		...
		$this->add_responsive_control(
            'container_wrapper_padding',
            [
                'label'              => __( 'Padding', 'classyea' ),
                'type'               => Controls_Manager::DIMENSIONS,
                'size_units'         => [ 'px', 'em', '%' ],
                'selectors'          => [
                    '{{WRAPPER}} .classyea-service-box-203' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    '{{WRAPPER}} .classyea-service-box-204' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    '{{WRAPPER}} .classyea-service-item-201' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    '{{WRAPPER}} .classyea-service-item-202' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    '{{WRAPPER}} .classyea-service-205' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    '{{WRAPPER}} .classyea-service-206 .classyea-service-box-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
        ...
        **/
		...
		$this->add_control(
			'title_border_on_off',
			[
				'label' => esc_html__( 'Title Border Enable?', 'classyea' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'classyea' ),
				'label_off' => esc_html__( 'Hide', 'classyea' ),
				'return_value' => 'yes',
				'default' => 'no',
				'condition' => [ 'service_layout'   => 'layout-3']
			]
		);
		...
		$this->add_responsive_control(
            ...
            [
                ...
                'size_units'         => [ 'px', 'em', '%' ],
                'selectors'          => [
                    '{{WRAPPER}} .classyea-service-heading' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'frontend_available' => true,
            ]
        );
		...
		$this->add_responsive_control(
            'main_content_text_margin',
            [
                'label'              => __( 'Margin', 'classyea' ),
                'type'               => Controls_Manager::DIMENSIONS,
                'size_units'         => [ 'px', 'em', '%' ],
                'selectors'          => [
                    '{{WRAPPER}} .classyea-service-text' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'frontend_available' => true,
            ]
        );
		...
		$this->add_responsive_control(
            ...
            [
                ...
                'size_units'         => [ 'px', 'em', '%' ],
                'selectors'          => [
                    '{{WRAPPER}} .classyea-service-item-201 img' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    '{{WRAPPER}} .classyea-service-item-201 .classyea-service-icon i' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'frontend_available' => true,
            ]
        );
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .classyea-service-item-201 .service-number' => 'top: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .classyea-service-item-201 .service-number' => 'right: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
            ...
            [
                ...
                'size_units'         => [ 'px', 'em', '%' ],
                'selectors'          => [
                    '{{WRAPPER}} .classyea-service-btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    '{{WRAPPER}} .classyea-btn-primary' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'frontend_available' => true,
            ]
        );
		$this->add_responsive_control(
            ...
            [
                ...
                'size_units'         => [ 'px', 'em', '%' ],
                'selectors'          => [
                    '{{WRAPPER}} .classyea-service-btn' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    '{{WRAPPER}} .classyea-btn-primary' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'frontend_available' => true,
            ]
        );
		...
		$this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .classyea-btn-primary' => 'color: {{VALUE}}',
                ],
                'separator' => 'before',
            ]
        );
		...
		$this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .classyea-btn-primary' => 'background: {{VALUE}}',
                ],
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .classyea-service-btn:hover' => 'background-color: {{VALUE}}',
                    '{{WRAPPER}} .classyea-btn-primary:hover' => 'background-color: {{VALUE}}',
                ]
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .classyea-service-btn:hover' => 'color: {{VALUE}}',
                    '{{WRAPPER}} .classyea-btn-primary:hover' => 'color: {{VALUE}}',
                ]
            ]
        );
		...
		$this->add_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
                    '{{WRAPPER}} .classyea-service-btn' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    '{{WRAPPER}} .classyea-btn-primary' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ]
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .classyea-service-btn,{{WRAPPER}} .classyea-btn-primary',
                'separator' => 'before',
            ]
        );
	 ...
	 * Render service repeater output on the frontend.
	 * @access protected
	 */
	protected function classyea_render_service_repeater_control()
	{
		...
		$subheading_enable  = $settings['subheading_enable'];
		...
		elseif($box_style == '3'){
			...
			<?php } elseif($service_layout == 'layout-6'){ ?>
				<div class="classyea-service">
					<?php if(!empty($settings['service_image']['url']) || !empty($settings['classyea_service_icons']['value'])) : ?>
					<div class="classyea-service-img">
						<?php $this->classyea_service_image_icon(); ?>
					</div>
					<?php endif;?>
			...
			<?php } else if ($service_layout == 'layout-3'){ 
				$title_border_on_off = $settings['title_border_on_off'];
				$on_off_border = '';
				if( $title_border_on_off == 'yes' ) {
					$on_off_border = 'border-enable';
				}
				?>
			<div class="classyea-service-box-1 <?php echo esc_attr($on_off_border);?>">
				<div class="classyea-service-item-201 <?php echo esc_attr($box_class_two);?>">
					<?php $this->classyea_service_image_icon(); ?>
					<?php if(!empty($settings['service_number'])){?>
					<div class="service-number"><?php echo wp_kses($settings['service_number'],'classyea_kses');?></div>
					<?php } ?>
					<?php
					if($subheading_enable == 'yes') { 
						$service_sub_heading = $settings['service_sub_heading'];
						?>
					<p class="subtitle">
						<?php echo wp_kses($service_sub_heading,'classyea_kses'); ?>
					</p>
					<?php } 
					$this->classyea_service_title_description(); 
					$this->classyea_service_item_button(); ?>
	...
	protected function classyea_service_title_description()
	{
		...
		?>
			<a <?php echo wp_kses_post($this->get_render_attribute_string($link_key)); ?>>
				<?php
				if ($service_heading) {
					$service_heading_tag = Classyea_Helper::classyea_validate_html_tag($settings['service_heading_tag']);
				?>
			...
			<?php
			if ($service_content) {
				$service_content_tag = Classyea_Helper::classyea_validate_html_tag($service_content_tag);
			?>
			...
			if ($service_heading) {
				$service_heading_tag = Classyea_Helper::classyea_validate_html_tag($service_heading_tag);
			?>
				<<?php echo esc_html($service_heading_tag); ?> <?php echo wp_kses_post($this->get_render_attribute_string('service_heading')); ?>>
					<?php echo wp_kses($service_heading,'classyea_kses'); ?>
				</<?php echo esc_html($service_heading_tag); ?>>

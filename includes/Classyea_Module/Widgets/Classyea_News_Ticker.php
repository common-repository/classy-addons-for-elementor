...
class Classyea_News_Ticker extends Widget_Base
{
    ...
    protected function render()
    {
        ...
        $this->add_render_attribute( 'newsticker_settings', 'data-id' , wp_json_encode( $changed_atts ) );
                    ...
                    <div class="classyea-newsticker-inner-box">
                        <div class="classyea-newsticker-left-side">
                            <ul class="classyea-newsticker-list">
                                <li><?php echo wp_kses_post($this->classyea_news_label_icon($settings)); ?> <?php echo wp_kses($sticky_title, 'classyea_kses'); ?></li>
                        ...
                        <div class="classyea-newsticker-right-side">
                            ...
                            <div class="swiper-container classyea-newsticker-carousel9" id="newsticker_nine" <?php $this->print_render_attribute_string( 'newsticker_settings' ); ?>>
                                ...
                                <?php
                                    ...
                                    <div class="swiper-slide">
                                        <div class="classyea-newsticker-title style-one">
                                            <?php
                                            echo wp_kses_post(wp_trim_words(get_the_title(), $title_length, ''));
                                            ?>
                                        </div>
                                    </div>
                                    <?php
                ...
                <div class="container">
                    <div class="classyea-newsticker-inner-box-two">
                        <div class="classyea-newsticker-right-side-two">
                            <div class="classyea-newsticker-label-two"><?php echo wp_kses_post($this->classyea_news_label_icon($settings)); ?> <?php echo wp_kses($sticky_title, 'classyea_kses'); ?></div>
                            <div class="swiper-container classyea-newsticker-carousel" id="newsticker_two" <?php $this->print_render_attribute_string( 'newsticker_settings' ); ?>>
                                <div class="swiper-wrapper">
                                    <?php
                                    if ($query_args->have_posts()) {
                                        while ($query_args->have_posts()) {
                    ...
                    <div class="classyea-newsticker-inner-box">
                        <div class="classyea-newsticker-left-side">
                            <div class="classyea-newsticker-logo">
                                <?php echo wp_kses_post($this->logo_image($settings)); ?></div>
                        </div>
                        <div class="classyea-newsticker-right-side">
                            <div class="classyea-newsticker-label">
                                <?php echo wp_kses_post($this->classyea_news_label_icon($settings)); ?> <?php echo wp_kses($sticky_title, 'classyea_kses'); ?></div>
                            <div class="swiper-container classyea-newsticker-carousel10" id="newsticker_ten" <?php $this->print_render_attribute_string( 'newsticker_settings' ); ?>>
                                <div class="swiper-wrapper">
                                <?php
                                if ($query_args->have_posts()) {
                                    while ($query_args->have_posts()) {
        ...
        <?php } elseif ($newsticker_layout == 'layout-4') { ?>
            <div class="classyea-newsticker-wrapper-two newsticker-layout-four">
                <div class="container">
                    <div class="classyea-newsticker-inner-box-two">
                        <div class="classyea-newsticker-right-side-two">
                            <div class="classyea-newsticker-label-two style-two"><?php echo wp_kses_post($this->classyea_news_label_icon($settings)); ?> <?php echo wp_kses($sticky_title, 'classyea_kses'); ?></div>
                            <div class="swiper-container classyea-newsticker-carousel2" id="newsticker_four" <?php $this->print_render_attribute_string( 'newsticker_settings' ); ?>>
                                <div class="swiper-wrapper">
                                    <?php
                                    if ($query_args->have_posts()) {
                                        $count = 1;
                ...
                <div class="container">
                    <div class="classyea-newsticker-inner-box-two">
                        <div class="classyea-newsticker-right-side-two style-two">
                            <div class="swiper-container classyea-newsticker-carousel3" id="newsticker_five" <?php $this->print_render_attribute_string( 'newsticker_settings' ); ?>>
                                <div class="swiper-wrapper">
                                    <?php
                                    if ($query_args->have_posts()) {
                                        $count = 1;
                ...
                <div class="container">
                    <div class="classyea-newsticker-inner-box-two">
                        <div class="classyea-newsticker-right-side-two style-three">
                            <div class="swiper-container classyea-newsticker-carousel4" id="newsticker_six" <?php $this->print_render_attribute_string( 'newsticker_settings' ); ?>>
                                <div class="swiper-wrapper">
                                    <?php
                                    if ($query_args->have_posts()) {
                                        $count = 1;
        ...
        <?php } elseif ($newsticker_layout == 'layout-7') { ?>
            <div class="classyea-newsticker-wrapper-two layout-seven">
                <div class="container">
                    <div class="classyea-newsticker-inner-box-two">
                        <div class="classyea-newsticker-right-side-two style-three">
                            <div class="swiper-container classyea-newsticker-carousel5" id="newsticker_seven" <?php $this->print_render_attribute_string( 'newsticker_settings' ); ?>>
                                <div class="swiper-wrapper">
                                    <?php
                                    if ($query_args->have_posts()) {
                                        $count = 1;
        ...
        <?php } elseif ($newsticker_layout == 'layout-8') { ?>
            <div class="classyea-newsticker-wrapper-two">
                <div class="container">
                    <div class="classyea-newsticker-inner-box-two">
                        <div class="classyea-newsticker-right-side-two style-two">
                            <div class="swiper-container classyea-newsticker-carousel6" id="newsticker_eight" <?php $this->print_render_attribute_string( 'newsticker_settings' ); ?>>
                                <div class="swiper-wrapper">
            ...
            <div class="classyea-newsticker-wrapper-two layout-nine">
                <div class="container">
                    <div class="classyea-newsticker-inner-box-two">
                        <div class="classyea-newsticker-right-side-two">
                            <div class="classyea-newsticker-label-two style-two"><?php echo wp_kses_post($this->classyea_news_label_icon($settings)); ?> <?php echo wp_kses($sticky_title, 'classyea_kses'); ?></div>
                            <div class="swiper-container classyea-newsticker-carousel7" id="newsticker_eleven" <?php $this->print_render_attribute_string( 'newsticker_settings' ); ?>>
                                <div class="swiper-wrapper">
                                    <?php
                                    if ($query_args->have_posts()) {
                                        $count = 1;
                ...
                <div class="container">
                    <div class="classyea-newsticker-inner-box-two">
                        <div class="classyea-newsticker-right-side-two style-four">
                            <div class="classyea-newsticker-label-two style-three"><?php echo wp_kses_post($this->classyea_news_label_icon($settings)); ?> <?php echo wp_kses($sticky_title, 'classyea_kses'); ?></div>
                            <div class="swiper-container classyea-newsticker-carousel8" id="newsticker_twelve" <?php $this->print_render_attribute_string( 'newsticker_settings' ); ?>>
                                <div class="swiper-wrapper">
                                    <?php
                                    if ($query_args->have_posts()) {
                                        $count = 1;
